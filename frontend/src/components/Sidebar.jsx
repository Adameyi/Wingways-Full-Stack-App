...
function Sidebar() {
    return (
        <div className='col-span-2 bg-white p-4 border-t-2'>
            <div className='fixed flex flex-col justify-between'>
                <div className='mb-4'>
                    <a className='bg-[#454545] text-white p-2 px-4 flex items-center gap-2 text-[1.25rem] shadow-lg'>
                    ...
                    <a className='mt-2 p-2 px-4 flex items-center gap-2 text-[1.25rem]'>
                        ...
                        Inbox
                        <div className=' h-6 w-6 bg-blue-800 text-[0.9rem] text-white flex justify-center items-center rounded-full roboto-bold'>
                            3
                        </div>
                    </a>
                    <a className='mt-2 p-2 px-4 flex items-center gap-2 text-[1.25rem]'>
                    ...
                    <a className='mt-2 p-2 px-4 flex items-center gap-2 text-[1.22rem]'>
