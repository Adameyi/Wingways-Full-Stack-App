...
function Values() {
    return (
        <section className='h-[120vh] text-center mt-24'>
            ...
            <div className='mt-6 w-[60%] container mx-auto grid grid-cols-1 md:grid-cols-1 lg:grid-cols-3 gap-4'>
                {/* col */}
                <div className='flex flex-col items-center col-span-1 p-4 border-2 p-4 rounded-lg'>
                    <div className='bg-cover bg-[url("../assets/images/familyTrip.png")]w-full h-64 rounded-lg shadow-lg' />
                ...
                {/* col */}
                <div className='flex flex-col items-center col-span-1 p-4 border-2 p-4 rounded-lg'>
                    <div className='bg-cover bg-[url("../assets/images/accommodation.png")] w-full h-64 rounded-lg shadow-lg' />
