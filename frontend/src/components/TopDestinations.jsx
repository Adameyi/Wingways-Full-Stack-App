...
const destinations = [
    {
        ...
        name: 'Norway',
        city: 'Oslo',
        image: '../assets/images/window_norway.png'
    },
    {
        id: 2,
        name: 'Norway',
    ...
    return (
        <section className='h-[120vh] text-center mt-24 '>
            ...
            <div className='relative container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mt-10 px-20'>
                ...
                {/* Left Button */}
                <div onClick={prevSlide} className='absolute top-48 shadow-xl h-12 w-12 rounded-full flex justify-center items-center z-10'>
                ...
                {/* Right Button */}
                <div onClick={nextSlide} className='absolute top-48 right-0 shadow-xl h-12 w-12 rounded-full flex justify-center items-center z-10'>
