...
function HotelHero() {
    return (
        <div>
            <div
                className='absolute w-[70vw] h-screen right-0 bg-cover rounded-bl-3xl'
                style={{
            ...
            >
                ...
                <div className='absolute left-10 bottom-10 grid grid-cols-3'>
                    ...
                    <div className='col-span-2 mx-4 flex flex-col justify-between'>
                        <div className='flex flex-row'>
                            <div className='mt-2 h-16 w-3 mr-4 bg-white' />
                            <h1 className='roboto-regular text-white text-[1.6rem]'>Discover your ultimate escape at
                        ...
                        <div className='flex flex-row'>
                            ...
                            <button className='ml-4 bg-black text-white rounded-full p-3 px-4 gap-2 flex flex-row'>
            ...
            <Navbar />
            <div className='grid grid-cols-3 roboto-light'>
                {/* Main Left Column */}
                <div className='col-span-1 container px-6'>
                    <h1 className='roboto-medium text-[3rem] leading-[3rem]'>Book Your Dream Getaway Today!</h1>
                    ...
                    <div className='flex flex-row gap-4'>
                        <div className='bg-gray-200 p-4 h-28 w-28 text-gray-500 rounded-2xl flex flex-col justify-center items-center text-center'>
                            ...
                            <p className='leading-[1rem]'>Lux Rooms Booked</p>
                        </div>
                        <div className='bg-gray-200 p-4 h-28 w-28 text-gray-500 rounded-2xl flex flex-col justify-center items-center text-center'>
