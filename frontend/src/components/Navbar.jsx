...
function Navbar() {
    ...
    return (
        ...
        >
            <a href="/" className={`navbar-brand ${isSlideshow ? 'text-white' : 'text-navy-blue'} font-roboto font-bold text-[2rem] text-[#000F94] mt-3`}>WingWays</a>
            <ul className={` ${isSlideshow ? 'text-white' : 'text-gray-800'} navbar-links flex gap-4 mt-2`}>
